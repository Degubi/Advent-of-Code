...
public class Day7 {
    ...
    public static void main(String[] args) throws Exception {
        var splitLines = Files.lines(Path.of("Day7.txt"))
                              .map(k -> k.split(" ", 2))
                              .toArray(String[][]::new);

        var part1Result = calculateWinnings(splitLines, Day7::getCardCounts, Day7::getCardRankPart1);
        var part2Result = calculateWinnings(splitLines, Day7::getBestCardCounts, Day7::getCardRankPart2);
    ...
    static Map<Character, Long> getBestCardCounts(String cards) {
        ...
        return cardCounts.keySet().stream()
                         ...
                         .max((h1, h2) -> compareHands(h1, h2, Day7::getCardRankPart2))
                         .orElseThrow()
                         .cardCounts();
    }

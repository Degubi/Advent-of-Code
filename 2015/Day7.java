...
public class Day7 {
    ...
    public static void main(String[] args) throws Exception {
        var operations = Files.lines(Path.of("Day7.txt"))
                              .map(Day7::parseOperation)
    ...
    static HashMap<String, Integer> calculateVariables(HashMap<String, Integer> variables, Operation[] operations) {
        return Stream.iterate(variables, k -> Arrays.stream(operations).reduce(k, Day7::updateVariables, (m, l) -> l))
    ...
    static HashMap<String, Integer> updateVariables(HashMap<String, Integer> variables, Operation operation) {
        variables.computeIfAbsent(operation.resultName(), l -> switch(operation) {
